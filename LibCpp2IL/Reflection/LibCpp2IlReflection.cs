...
public static class LibCpp2IlReflection
{
    ...
    internal static void InitCaches()
    {
        ...
        // goofy ahhh fix for abe not having this type, and using First() would throw a no match exception
        var typedByRef = LibCpp2IlMain.Binary!.AllTypes.FirstOrDefault(t => t.Type == Il2CppTypeEnum.IL2CPP_TYPE_TYPEDBYREF && t.Byref == 0);
        if (typedByRef != null)
            PrimitiveTypeCache[Il2CppTypeEnum.IL2CPP_TYPE_TYPEDBYREF] = typedByRef;
